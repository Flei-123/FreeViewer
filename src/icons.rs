...
pub const ICONS: &[(&str, &str)] = &[
    ...
    (
        "friends",
        r##"<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.4"/><path d="M2.8 19.5c0-3.1 2.8-5.2 6.2-5.2s6.2 2.1 6.2 5.2"/><path d="M16.4 5.2a3.4 3.4 0 0 1 0 6.6"/><path d="M17.6 14.6c2.2.6 3.6 2.2 3.6 4.4"/></svg>"##,
    ),
    (
        "meet",
